...
using WebUI_v2.ViewModels.Account;
...
namespace WebUI_v2.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginVM user)
        {
            ...
            {
                ModelState.AddModelError("", "Too many false attempts , please try again in a few minutes");
                return View(user);
            }
            ...
            {
                ModelState.AddModelError("", "Please wait for avtivation by Admin");
                return View(user);
            }
            return RedirectToAction("Index", "Home");
        }
